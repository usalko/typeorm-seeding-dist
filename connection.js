...
var configureConnection = function (option) {
...
var setConnectionOptions = function (options) {
    ;
    global[KEY].overrideConnectionOptions = options;
};
exports.setConnectionOptions = setConnectionOptions;
var getConnectionOptions = function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
...
var createConnection = function (option) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, typeorm_1.getConnection)(configureOption.name)];
            case 2:
                connection = _a.sent();
                return [3 /*break*/, 4];
            case 3:
