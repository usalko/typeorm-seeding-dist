            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        log('🌱  ' + chalk.bold("TypeORM Seeding v".concat(pkg.version)));
                    ...
                    case 8:
                        ...
                        seedFiles = (0, file_util_1.loadFiles)(option.seeds);
                        seedFileObjects = [];
                        _a.label = 9;
                    case 9:
                        _a.trys.push([9, 11, , 12]);
                        return [4 /*yield*/, Promise.all(seedFiles.map(function (seedFile) { return (0, importer_1.importSeed)(seedFile); }))];
                    case 10:
                    ...
                    case 17:
                        ...
                        spinner.start("Executing ".concat(seedFileObject.name, " Seeder"));
                        _a.label = 18;
                    case 18:
                        _a.trys.push([18, 20, , 21]);
                        return [4 /*yield*/, (0, typeorm_seeding_1.runSeeder)(seedFileObject)];
                    case 19:
                        _a.sent();
                        spinner.succeed("Seeder ".concat(seedFileObject.name, " executed"));
                        return [3 /*break*/, 21];
                    case 20:
                        error_5 = _a.sent();
                        panic(spinner, error_5, "Could not run the seed ".concat(seedFileObject.name, "!"));
                        return [3 /*break*/, 21];
                    case 21:
                        _i++;
                        return [3 /*break*/, 17];
